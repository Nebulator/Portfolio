    ...
    return (
        <>
            ...
            <div className="Portfolio">
                <Section
                    image={Profile}
                    title={"BYU-Pathway Portal"}
                    description={"While working for The Church of Jesus Christ, I helped maintain and build up the BYU Pathway Portal and Online Degree Portal. These applications used .net5 and api calls to send and receive information from our database. I developed modules such as the certificate and courses modules. I worked closely with the designers, standardized some styles across the two apps and made the UI cleaner, especially on the mobile view."}
                    />
                <Section
                    image={Compiler}
