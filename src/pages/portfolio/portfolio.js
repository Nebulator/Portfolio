...
function Portfolio() {
  return (
    <div className="Portfolio">
      <Section image={Profile} title={"BYU-Pathway Portal"}description={"While working for The Church of Jesus Christ, I helped maintain and build up the BYU Pathway Portal and Online Degree Portal. I develop modules such as the certificate and courses modules. I worked closely with the designers, standardized some styles across the two apps and made the UI cleaner, especially on the mobile view."}/>
