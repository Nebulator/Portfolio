...
class NavBar extends React.Component {
  ...
  render () {
    ...
    return (
      <>
        <div className="bar">
              <a className="nav-link" href="www.google.com">Portfolio</a>
              <a className="nav-link" href="www.google.com">Resume</a>
              <a className="nav-link" href="www.google.com">About Me</a>
